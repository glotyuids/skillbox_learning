        ...
        'steps': {
            'step1': {
                'text': 'Чтобы зарегистрироваться, введите ваше имя. \n'
                        'На это имя вы сможете получить парковочное место, палатку и обед в полевой кухне',
...
DEFAULT_ANSWER = 'Я не знаю как на это ответить. \n' \
                 'Я могу рассказать когда и где пройдёт крупнейшая в мире коференция, а также зарегистрировать вас'