...
#  подобную конструкцию я использовал для утаскивания данных с сетевых ресурсов или из последовательного порта
...
# зачет! Только тут надо использовать Exception, так BaseException включают в себя системные исключения и т.д.
