...
#  Всё же для имени цвета выделю отдельный ключ. Причины - в тудушке ниже
...
while not global_color:
    ...
    #  Теперь понял. Логично, так обслуживание кода будет проще
    ...
    if user_answer.isnumeric():
        ...
        for color in COLORS:
            ...
            #  преобразование к нижнему регистру делаётся сразу после считывания.
