...
# TOdO Задумка была как раз в том, чтобы использовать эту структуру данных и для вывода меню и для получения кода цвета.
...
while not global_color:
    print(' 0 - красный, \n'
          ...
          ' 5 - синий, \n'
          ' 6 - фиолетовый')
    # TODO Константа данных о цветах для того и введена, чтобы если понадобится добавить цвет, это можно было сделать в
    ...
    # TOdO Константы должны быть сразу после импортов сторонних модулей. Там их легче найти при надобности
    ...
    if user_answer.isnumeric():
        ...
        for color in COLORS:  # TODO Если вас так это вдохновило, то можно переделать на оборот: искать вхождение ответа
