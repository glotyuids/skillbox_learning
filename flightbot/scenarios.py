    ...
    'find_flights': {
        ...
        'steps': {
            ...
            'enter_seats': {
                ...
                'failure_1': 'Вы ввели не число. Попробуйте ещё раз или отправьте /exit для выхода',
                'failure_2': 'Вы выбрали больше мест, чем достумно в самолёте. '
                             'Попробуйте ещё раз или отправьте /exit для выхода',
                'handler': 'seats_handler',
                'next_step': 'enter_comment',
            },
            'enter_comment': {
            ...
            'verify_details': {
                ...
                'failure_1': 'Я не понял вашего ответа. Введите "да" или "нет", либо отправьте /exit для выхода',
                'handler': 'verify_data_handler',
                'next_step': 'enter_phone',
            },
            'enter_phone': {
                ...
                'failure_1': 'Некорректный формат номера. Введите номер в формате +7 999 123 45 67',
...
DEFAULT_ANSWER = 'Я не знаю как на это ответить.\n' \
                 'Для вывода помощи введите /help'

HELP_ANSWER = 'Для поиска рейса введите /ticket.\n' \
