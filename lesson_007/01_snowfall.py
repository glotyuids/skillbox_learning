...
while True:
    sd.start_drawing()
    #  Для того, чтобы избавиться от синих артефактов при наложении снежинок, вынес отрисовку синих в отдельный цикл
    for flake in flakes:
        flake.clear_previous_picture()
    ...
    if fallen_flakes_numbers:
        ...
        #  В принципе да, просто я пытался вписать код в изначально предложенный "скелет" программы. Исправил)
