...
#  попробую переносами разделять логические блоки. Это допустимо?
# Вы про вставку пустых строк? Да, это нормально. Но больше двух пустых строк РЕР8 не допускает.
