...
#  Лихой трюк) Я не сразу разобрался что в этом генераторе списков происходит.
...
# В данном случае это была скорее шутка, чем серъёзно. А на счёт извлечения нескольких значений в цикле из словаря -
# то это называется распаковка и это один из больших плюсов питона. Её вы будет проохить в третьем модуле.
