...
class TTradeAnalyzer(threading.Thread):
    def __init__(self, ticker_filename, results_list, lock, *args, **kwargs):
    ...
    def run(self):
        ...
        with self.lock:
            self.results_list.append({'name': self.ticker_name, 'volatility': self.volatility})
...
for ticker in trades_list:
    analyzers_list.append(TTradeAnalyzer(ticker, volatility_list, lock))
