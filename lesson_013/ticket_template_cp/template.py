...
fields = [
    ...
    {'data_type': 'origin', 'pos': (162, 238), 'font': font_regular, 'font_size': 20, 'capital': True, 'max_length': 26},
    {'data_type': 'dest', 'pos': (162, 313), 'font': font_regular, 'font_size': 20, 'capital': True, 'max_length': 26},
    ...
    {'data_type': 'fare_code', 'pos': (465, 238), 'font': font_regular, 'font_size': 20, 'capital': True, 'max_length': 11},
    ...
    {'data_type': 'origin', 'pos': (899, 199), 'font': font_regular, 'font_size': 16, 'capital': False, 'max_length': 26},
    {'data_type': 'dest', 'pos': (880, 218), 'font': font_regular, 'font_size': 16, 'capital': False, 'max_length': 26},
